...
(tinyHippos.Persistence = (($, JQuery) => {
    ...
    function _validateAndSetPrefix(prefix) {
        ...
        // changed this to your desired constant
    ...
    return {
        ...
        currentPersistence() {
            return _persistenceTypes[_currentPersistence];
        },
